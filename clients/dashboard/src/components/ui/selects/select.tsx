          ...
          <div ref={ref} {...props}>
            ...
            <button
              ...
              className={cn(
                ...
                !noFocusStyles && isOpen && "ring-2 ring-indigo-500 border-indigo-500",
            ...
            {/* Dropdown */}
            {isOpen && !loading && (
              <div className="absolute z-50 min-w-full w-max max-w-2xl mt-1 border border-slate-200 rounded-lg shadow-lg max-h-80 overflow-hidden">
                {/* Search Input */}
                {searchable && (
