...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    popularity: 4,
    pricing: "Pro",
    description: "Connect Zeiro insights directly to Tableau for advanced data visualization and dashboard creation.",
    exportType: "API",
    frequency: "Real-time",
    format: "JSON/CSV",
    exportSteps: [
      {
        ...
        description: "Create a secure API connection between Zeiro and Tableau."
      },
      {
        title: "Configure data source",
        description: "Set up Zeiro as a data source in your Tableau workspace."
      },
      {
        title: "Build visualizations",
        description: "Create charts and dashboards using your Zeiro data in Tableau."
      }
    ],
    documentation: "https://docs.zeiro.com/integrations/tableau",
  ...
  },
  {
    ...
    popularity: 4,
    pricing: "Pro",
    description: "Stream your Zeiro analytics directly into Microsoft Power BI for enterprise-grade reporting and visualization.",
    exportType: "API",
    frequency: "Real-time",
    format: "JSON",
    exportSteps: [
      {
        title: "Connect Power BI account",
        description: "Link your Microsoft Power BI workspace to Zeiro."
      },
      {
        title: "Set up data connector",
        description: "Configure the Zeiro connector in Power BI Desktop or Service."
      },
      {
        title: "Create reports",
        description: "Build interactive reports and dashboards with your Zeiro data."
      }
    ],
    documentation: "https://docs.zeiro.com/integrations/powerbi",
  ...
  },
  {
    ...
    popularity: 5,
    pricing: "Free",
    description: "Trigger automated workflows based on your data insights. Connect Zeiro to thousands of apps through Zapier.",
    exportType: "Webhook",
    ...
    exportSteps: [
      {
        ...
        description: "Sign up for Zapier and find the Zeiro integration."
      },
      {
        title: "Set up trigger",
        description: "Configure what Zeiro events should trigger your automation."
      },
      {
        title: "Connect actions",
        description: "Define what happens when your Zeiro trigger fires."
      }
    ],
    documentation: "https://docs.zeiro.com/integrations/zapier",
  ...
  },
  {
    ...
    popularity: 3,
    pricing: "Free",
    description: "Send real-time data updates to any endpoint. Perfect for custom integrations and developer workflows.",
    exportType: "Real-time",
    frequency: "Event-based",
    format: "JSON",
    exportSteps: [
      {
        ...
        description: "Set up your webhook URL and authentication method."
      },
      {
        title: "Define payload",
        description: "Specify what data should be sent in webhook requests."
      },
      {
        title: "Test connection",
        description: "Verify your webhook is receiving data correctly."
      }
    ],
    documentation: "https://docs.zeiro.com/integrations/webhooks",
    website: "https://zeiro.com/webhooks"
  },
  {
    name: "Gmail",
    slug: "gmail",
