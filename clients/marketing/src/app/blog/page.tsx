      ...
      <section className="py-4 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 lg:col-span-3 bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden hover:bg-gray-900/80 hover:border-gray-700 transition-all duration-300">
              <div className="p-8">
                ...
                <h2 className="text-3xl font-bold text-foreground mb-4 hover:text-muted-foreground transition-colors">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-foreground text-sm font-medium">Sarah Chen</div>
                      <div className="text-muted-foreground text-xs">Head of Product</div>
                    </div>
                  </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden hover:bg-gray-900/80 hover:border-gray-700 transition-all duration-300">
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-foreground mb-3 hover:text-muted-foreground transition-colors">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-muted-foreground text-sm">Mike Johnson</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden hover:bg-gray-900/80 hover:border-gray-700 transition-all duration-300">
              <div className="p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-muted-foreground text-sm">Alex Rivera</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden hover:bg-gray-900/80 hover:border-gray-700 transition-all duration-300">
              <div className="p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-muted-foreground text-sm">Emma Davis</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden hover:bg-gray-900/80 hover:border-gray-700 transition-all duration-300">
              <div className="p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-muted-foreground text-sm">David Kim</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden hover:bg-gray-900/80 hover:border-gray-700 transition-all duration-300">
              <div className="p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-muted-foreground text-sm">Lisa Park</div>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mt-12">
            <button className="bg-gray-800 text-foreground px-8 py-3 rounded-lg hover:bg-gray-700 transition-colors font-medium">
              Load more posts
            </button>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-md mx-auto flex gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 bg-gray-900/50 border border-gray-800 rounded-lg text-foreground placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-transparent"
            />
