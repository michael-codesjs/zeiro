    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <header className="px-6 py-4">
        <div className="max-w-7xl mx-auto">
          <Link href="/" className="font-bold text-foreground text-2xl hover:text-muted-foreground transition-colors">
            zeiro
          </Link>
        </div>
      </header>
      ...
      <main className="flex-grow flex items-center justify-center px-6 py-12">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="/features" 
              className="inline-flex items-center gap-2 px-6 py-3 border border-gray-700 text-foreground rounded-lg hover:bg-gray-900 transition-colors font-medium"
            >
          ...
          <div className="mt-12 text-sm text-gray-500">
            <p>Need help? <Link href="/contact" className="text-foreground hover:text-muted-foreground transition-colors">Contact us</Link></p>
          </div>
        </div>
      </main>
