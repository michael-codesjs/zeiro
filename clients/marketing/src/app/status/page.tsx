  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 text-center">
              ...
              <div className="text-gray-400 mb-1">Avg Response Time</div>
      ...
      <section className="py-16 px-6 border-t border-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-3">Service Status</h2>
            <p className="text-gray-400">Current operational status of all Zeiro services</p>
          </div>
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 transition-colors">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white">API Service</h3>
                    <p className="text-sm text-gray-400">Core API endpoints</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Data source connectivity</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <TickCircle size={20} color="#4ade80" variant="Outline" />
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 transition-colors">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white">Query Engine</h3>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Slack, email notifications</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <TickCircle size={20} color="#4ade80" variant="Outline" />
      ...
      <section className="py-16 px-6 border-t border-gray-800">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-3">System Health</h2>
          ...
          <div className="bg-green-600/5 border border-green-600/20 rounded-xl p-8 text-center">
            ...
            <h3 className="text-2xl font-semibold text-white mb-2">No Issues Detected</h3>
          ...
          <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 border border-blue-600/20 rounded-2xl p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 transition-colors"
              />
