        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">Independently audited security controls and processes.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">AES-256 encryption for data in transit and at rest.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">Multi-factor authentication and role-based permissions.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <div className="space-y-6 text-gray-300">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Encryption Standards</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Data Isolation</h3>
                  <ul className="space-y-2 ml-6">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white m-0">Infrastructure Security</h2>
              </div>
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white m-0">Access Management</h2>
              </div>
              ...
              <div className="space-y-6 text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Authorization</h3>
                  <ul className="space-y-2 ml-6">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white m-0">Monitoring and Detection</h2>
              </div>
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white m-0">Compliance and Certifications</h2>
              </div>
              ...
              <div className="space-y-6 text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Data Residency</h3>
                  <ul className="space-y-2 ml-6">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white m-0">Incident Response</h2>
              </div>
              
              <div className="space-y-6 text-gray-300">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Response Plan</h3>
                  <ul className="space-y-2 ml-6">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white m-0">Employee Security</h2>
              </div>
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white m-0">Your Security Best Practices</h2>
              </div>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-white mb-6">Contact Our Security Team</h2>
              <div className="space-y-4 text-gray-300">
            ...
            {/* Security Updates */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-white mb-6">Stay Informed</h2>
              <div className="space-y-4 text-gray-300">
