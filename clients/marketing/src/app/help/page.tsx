    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="text-center mb-12">
            ...
            <div className="relative max-w-2xl mx-auto mb-12">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-gray-900/50 border border-gray-700 rounded-xl text-foreground placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-gray-900 transition-all"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/contact" className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 text-center hover:bg-gray-900/50 hover:border-gray-700 transition-all group">
                ...
                <p className="text-muted-foreground text-sm">Get personalized help from our team</p>
              </Link>
              ...
              <Link href="/status" className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 text-center hover:bg-gray-900/50 hover:border-gray-700 transition-all group">
                ...
                <p className="text-muted-foreground text-sm">Check service availability</p>
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 hover:border-gray-700 transition-all group">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-semibold text-foreground">Queries & Analysis</h3>
              </div>
              <ul className="space-y-3 text-muted-foreground">
                <li className="hover:text-foreground transition-colors cursor-pointer flex items-center gap-2">
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 hover:border-gray-700 transition-all group">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-semibold text-foreground">Account & Billing</h3>
              </div>
              <ul className="space-y-3 text-muted-foreground">
                <li className="hover:text-foreground transition-colors cursor-pointer flex items-center gap-2">
      ...
      <section className="py-16 px-6 border-t border-gray-800">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-3">Popular articles</h2>
            <p className="text-muted-foreground">The most helpful resources from our community</p>
          </div>
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 hover:border-gray-700 transition-all cursor-pointer group">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">Step-by-step guide to connecting PostgreSQL, MySQL, and other popular databases</p>
                </div>
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 hover:border-gray-700 transition-all cursor-pointer group">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">Tips and best practices for getting the most accurate results from your queries</p>
                </div>
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 hover:border-gray-700 transition-all cursor-pointer group">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">Configure alerts and reports to be sent directly to your team's Slack channels</p>
                </div>
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/50 hover:border-gray-700 transition-all cursor-pointer group">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">Learn about our enterprise-grade security measures and data protection policies</p>
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 border border-blue-600/20 rounded-2xl p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="bg-gradient-to-r from-blue-600 to-purple-600 text-foreground px-8 py-4 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all font-medium">
                Contact Support
              </Link>
              <button className="border border-gray-600 text-foreground px-8 py-4 rounded-lg hover:bg-gray-800 transition-colors font-medium">
                Schedule a Demo
              </button>
            </div>
          </div>
