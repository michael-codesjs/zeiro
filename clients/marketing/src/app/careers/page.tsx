      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link href="#culture" className="text-gray-300 hover:text-white transition-colors px-8 py-4 inline-flex items-center gap-2">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">User First</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Care Deeply</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Think Global</h3>
              <p className="text-gray-400 leading-relaxed">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400">We invest in our team's growth and wellbeing</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-white">Remote-first culture</h3>
              </div>
              <p className="text-gray-400">Work from anywhere with flexible hours and async communication.</p>
            </div>
            
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-3">
                <DollarCircle size={20} color="#4ade80" variant="Outline" />
                <h3 className="text-lg font-semibold text-white">Competitive compensation</h3>
              </div>
              <p className="text-gray-400">Market-rate salaries plus equity in a fast-growing company.</p>
            </div>
            
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-3">
                <Health size={20} color="#c084fc" variant="Outline" />
                <h3 className="text-lg font-semibold text-white">Health & wellness</h3>
              </div>
              <p className="text-gray-400">Comprehensive health insurance and wellness stipends.</p>
            </div>
            
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-3">
                <Book1 size={20} color="#fb923c" variant="Outline" />
                <h3 className="text-lg font-semibold text-white">Learning budget</h3>
              </div>
              <p className="text-gray-400">Annual budget for courses, conferences, and skill development.</p>
            </div>
            
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-3">
                <Calendar1 size={20} color="#22d3ee" variant="Outline" />
                <h3 className="text-lg font-semibold text-white">Unlimited PTO</h3>
              </div>
              <p className="text-gray-400">Take the time you need to recharge and maintain work-life balance.</p>
            </div>
            
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-3">
                <Monitor size={20} color="#f59e0b" variant="Outline" />
                <h3 className="text-lg font-semibold text-white">Top-tier equipment</h3>
              </div>
              <p className="text-gray-400">Latest MacBooks, monitors, and any tools you need to do your best work.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link href="/contact" className="text-gray-300 hover:text-white transition-colors px-8 py-4">
              Contact us
            </Link>
          </div>
        </div>
