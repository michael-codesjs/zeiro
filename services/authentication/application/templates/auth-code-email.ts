...
/**
 * Parameters for creating an authentication code email
 */
export interface AuthCodeEmailParams {
  to: EmailRecipient
  from: EmailRecipient
  code: string
...
/**
 * Creates an authentication code email message
 */
export function createAuthCodeEmail(params: AuthCodeEmailParams): EmailMessage {
  const {
    to,
    from,
    code,
  ...
  const subject = `Your Zeiro verification code: ${code}`
  ...
  const html = `
    ...
    <table class="t20" role="presentation" cellpadding="0" cellspacing="0" style="width:auto;max-width:514px;"><tr><td class="t19" style="overflow:hidden;background-color:#000000;text-align:center;line-height:50px;mso-line-height-rule:exactly;mso-text-raise:8px;padding:0 32px 0 32px;border-radius:8px 8px 8px 8px;"><span class="t17" style="display:block;margin:0;Margin:0;font-family:Sofia Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:50px;font-weight:700;font-style:normal;font-size:24px;text-decoration:none;text-transform:none;letter-spacing:4px;direction:ltr;color:#FFFFFF;text-align:center;mso-line-height-rule:exactly;mso-text-raise:8px;">${code}</span></td></tr></table>
    </td></tr></table>
...
We're here to help if you need it. Visit the Zeiro Support for more info or contact us at support@usezeiro.com.
