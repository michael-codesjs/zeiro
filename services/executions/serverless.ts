...
/** Serverless configuration for the 'executions' service. */
const serverlessConfiguration: AWS.Service = {
  service: 'zeiro-executions',
  frameworkVersion: '3',
  ...
  provider: {
    ...
    environment: {
      ...
      DATA_SOURCES_SERVICE_URL: '${ssm:/zeiro/${self:custom.stage}/infrastructure/io/central/api/url}',
      WEBSOCKET_SERVICE_URL: '${ssm:/zeiro/${self:custom.stage}/infrastructure/io/central/api/url}',
