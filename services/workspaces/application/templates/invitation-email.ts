import { EmailMessage, EmailRecipient } from '@zeiro/sdk'

/**
 * Parameters for creating an invitation email
 */
...
/**
 * Creates an invitation email message
 */
export function createInvitationEmail(params: InvitationEmailParams): EmailMessage {
  ...
  const subject = `You've been invited to join ${workspaceName} on Zeiro`
  ...
  const html = `
    ...
    <table class="t4" role="presentation" cellpadding="0" cellspacing="0" style="Margin-right:auto;"><tr><td class="t3" style="width:auto;">
    <table class="t2" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr><td class="t1"><div style="font-size:0px;"><span class="t0" style="display:block;margin:0;Margin:0;font-family:Montserrat,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:32px;font-weight:700;font-style:normal;font-size:28px;text-decoration:none;text-transform:none;letter-spacing:-1px;direction:ltr;color:#000000;text-align:left;mso-line-height-rule:exactly;mso-text-raise:1px;">zeiro</span></div></td></tr></table>
    </td></tr></table>
    ...
    <table class="t14" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr><td class="t13"><p class="t12" style="margin:0;Margin:0;font-family:Open Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:25px;font-weight:400;font-style:normal;font-size:15px;text-decoration:none;text-transform:none;letter-spacing:-0.1px;direction:ltr;color:#141414;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;"><strong>${inviterName}</strong> has invited you to join their workspace on Zeiro as a <strong>${role}</strong>. Click the button below to accept the invitation and start collaborating.</p></td></tr></table>
    </td></tr></table>
    </td></tr>${message ? `<tr><td><div class="t18" style="mso-line-height-rule:exactly;mso-line-height-alt:18px;line-height:18px;font-size:1px;display:block;">&nbsp;&nbsp;</div></td></tr><tr><td align="center">
    <table class="t50" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;"><tr><td width="514" class="t51" style="width:600px;">
    <table class="t52" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr><td class="t53" style="background-color:#FEF3C7;border-left:4px solid #F59E0B;padding:16px 20px;border-radius:0 8px 8px 0;"><p class="t54" style="margin:0;Margin:0;font-family:Open Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:22px;font-weight:400;font-style:italic;font-size:14px;text-decoration:none;text-transform:none;letter-spacing:-0.1px;direction:ltr;color:#92400E;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;"><strong style="color:#78350F;">Personal message:</strong><br>${message}</p></td></tr></table>
    </td></tr></table>
    ...
    <table class="t20" role="presentation" cellpadding="0" cellspacing="0" style="width:auto;max-width:514px;"><tr><td class="t19" style="overflow:hidden;background-color:#000000;text-align:center;line-height:34px;mso-line-height-rule:exactly;mso-text-raise:5px;padding:0 23px 0 23px;border-radius:40px 40px 40px 40px;"><a class="t17" href="${invitationUrl}" style="display:block;margin:0;Margin:0;font-family:Sofia Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:34px;font-weight:700;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;letter-spacing:-0.2px;direction:ltr;color:#FFFFFF;text-align:center;mso-line-height-rule:exactly;mso-text-raise:5px;">Accept Invitation</a></td></tr></table>
    </td></tr></table>
...
${inviterName} has invited you to join their workspace on Zeiro as a ${role}.
...
– Zeiro
  ...
  return {
    ...
    tags: {
      type: 'invitation',
      service: 'workspaces',
      role: role.replace(/[^a-zA-Z0-9_-]/g, ''), // Sanitize role to only ASCII letters, numbers, underscores, dashes
    },
  }
}
